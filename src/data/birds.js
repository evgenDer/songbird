const BIRDS_DATA = [
  ...
  [
    {
      ...
      description:
        "Средней величины птица (размером с куропатку), но тело плоское, сжато с боков. Ноги длинные с такими же пальцами, из которых средний длиннее плюсны. Оперение взрослых птиц в основном матово-черное. Спина и верхние конечности крыльев оливково-бурые.",
    ...
    },
    {
      ...
      species: "Crex crex",
      description:
        "Тело с боков плоское, клюв короткий, высокий у основания, сжатый посередине с боков. Голова сверху темно-бурая, щеки и брови серые. Спинные перья с продольными темными стержневыми пятнами, отчего общий фон спинной поверхности продольно-полосатый.",
    ...
    },
    {
      ...
      description:
        "Оперение самца, самки и молодой птицы окрашено почти одинаково. В брачном наряде часть головы аспидно-серая. Горло, шея, зоб, а также полоска над глазом пепельно-серые, спинная сторона оливково-бурая с крупными черными и мелкими белыми продольными пестринами.",
  ...
  [
    ...
    },
    {
      ...
      description:
        "краска оперения самца лутка белая, с черными пятнами возле клюва и на затылке, узкими поперечными полосами того же цвета на груди и спине. Кроющие крыльев и рулевые перья серые. Самка и молодые птицы буровато-серые.",
